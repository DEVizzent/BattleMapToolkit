...
- [x] 8.10 Movimiento de grupo: arrastrar selección múltiple → formación preservada — _5 tokens juntos → se mueven como grupo (MOV-07)_
- [x] 8.11 Ctrl + hover sobre celda → distancia desde token seleccionado — _Hover a 5 celdas → "25 pies (5 casillas)" (MOV-09)_
- [x] 8.12 Cambiar unidades a metros → etiquetas en metros — _2 celdas → "3.0 m (2 casillas)" (MOV-11)_
